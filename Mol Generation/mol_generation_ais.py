...
device = "cuda"
model_name = "rozariwang/GPT-AIS-sfs"
vocab_file = "./hhwang/shiawaseda/Datasets/ais_vocab.json"
tokenizer = AISTokenizer(vocab_file)
...
temperature = 1
file_name = 'GPT_ais_sfs_generated_mol_100000.csv'
